...
interface MessageComponentProps {
  ...
  isNextMessageSendBySameUser : boolean
}
const Message = forwardRef<HTMLDivElement, MessageComponentProps>(
  ({ message, isNextMessageSendBySameUser }, ref) => {
  return (
    <div className={cn('flex items-end',{
      ...
      <div className={cn("relative flex h-6 w-6 aspect-square items-center justify-center",{
        ...
        "order-3 bg-zinc-800 rounded-sm":!message.isUserMessage,
        invisible:isNextMessageSendBySameUser
      })}>
        {
      ...
      <div className={cn("flex flex-col space-y-2 text-base max-w-md mx-2",{
        ...
        <div className={cn("px-4 py-2 rounded-lg inline-block",{
          ...
          "rounded-br-none": !isNextMessageSendBySameUser && !message.isUserMessage
        })}>
          {
